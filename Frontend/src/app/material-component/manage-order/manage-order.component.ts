...
export class ManageOrderComponent implements OnInit {
  ...
  constructor(
    ...
    getCategories() {
        this.cateogryService.getFilteredCategories().subscribe((response:any)=>{
    ...
    validateSubmit() {
      if (this.totalAmount === 0 || this.manageOrderForm.controls['name'].value === null || this.manageOrderForm.controls['email'].value === null ||
        this.manageOrderForm.controls['phoneNr'].value === null || this.manageOrderForm.controls['paymentMethod'].value === null) {
          return true;
      }
      else {
        return false;
    ...
    add() {
      ...
      if (productName === undefined) {
        ...
        this.snackbarService.openSnackBar(GlobalConstatns.productExistsError, GlobalConstatns.error);
      }
    }
