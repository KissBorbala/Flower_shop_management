        ...
        try {
            if(jwtFilter.isAdmin()) {
                if(validateCategoryMap(requestMap, false)) {
                    ...
                    return FlowerShopUtils.getResponseEntity("Category added successfully!", HttpStatus.OK);
                }
            }
            else {
            ...
            if(jwtFilter.isAdmin()) {
                if (validateCategoryMap(requestMap, true)) {
                    ...
                    if(!optional.isEmpty()) {
                        ...
                        return FlowerShopUtils.getResponseEntity("Category updated successfully!", HttpStatus.OK);
                    }
                    else {
                        return FlowerShopUtils.getResponseEntity("Category id does not exist!", HttpStatus.OK);
                    }
                }
